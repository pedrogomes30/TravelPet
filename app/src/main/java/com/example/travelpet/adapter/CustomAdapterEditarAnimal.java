...
public class CustomAdapterEditarAnimal extends ArrayAdapter {
    public CustomAdapterEditarAnimal(@NonNull Context context, ArrayList<CustomItem> customList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.custom_spinner_layout_editar_animal, parent, false);
        }
